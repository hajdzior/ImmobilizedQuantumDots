...
def plplot(x,xmin,alpha,xname,datasig,fitsig):
    ...
    if f_dattype== 'REAL':
        ...
        h[0]=plt.loglog(c1, c2, datasig,markersize=8,markerfacecolor=[1,1,1],markeredgecolor=[0,0,1])
        h[1]=plt.loglog(q, cf, fitsig,linewidth=2)
        ...
        h[0]=plt.loglog(c1, c2, datasig,markersize=8,markerfacecolor=[1,1,1],markeredgecolor=[0,0,1])
        h[1]=plt.loglog(cf1, cf2, fitsig,linewidth=2)
