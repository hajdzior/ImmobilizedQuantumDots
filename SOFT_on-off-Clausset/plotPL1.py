...
def plplot(x,xmin,alpha,xname):
    ...
    if f_dattype== 'REAL':
        ...
        h[0]=plt.plot(c1, c2, 'r*',markersize=8,markerfacecolor=[1,1,1],markeredgecolor=[0,0,1])
        h[1]=plt.plot(q, cf, 'k--',linewidth=2)
        ...
        h[0]=plt.plot(c1, c2, 'g*',markersize=8,markerfacecolor=[1,1,1],markeredgecolor=[0,0,1])
        h[1]=plt.plot(cf1, cf2, 'k--',linewidth=2)
